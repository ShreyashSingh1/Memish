data = {
    ...
    "black_guys_taking_notes_jamal_randle_loren_cowling_and_dave_jackson_notebook_write_notes_crire_cahier": os.path.join(working_dir, "img_templates", "Black_Guys_Taking_Notes_Jamal_Randle_Loren_Cowling_and_Dave_Jackson_Notebook_Write_Notes_crire_cahier.jpg"),
