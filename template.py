...
def analyze_prompt_with_gemini(prompt):
    ...
    genai.configure(api_key="AIzaSyCEDJ1aaSEGimwoSgF-bSNY2PP4i-j4_Kc")
...
def add_text_to_image(img, top_text, bottom_text, font=cv2.FONT_HERSHEY_SIMPLEX):
    ...
    wrapped_top_text = wrap_text(top_text_1, font, font_scale, max_text_width)
    wrapped_bottom_text = wrap_text(bottom_text_1, font, font_scale, max_text_width)
